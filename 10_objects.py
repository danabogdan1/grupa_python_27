...
def add_person(param_list, person):
    if len(person) > 2:
        ...
        print("Name has to be 3 characters or longer!")


lista_persoane = ["John Wick", "Winston", "Daisy"]
add_person(lista_persoane, "Cassian")
add_person(lista_persoane, "IN")
...
# exemplu de functie care returneaza mai multe tipuri de date:
# db -> database
...
# cand facem .append() la lista_persoane2, schimbarea se reflecta si in diftionarul db, fiindca dictionarul db tine minte o referinta spre aceasta lista
